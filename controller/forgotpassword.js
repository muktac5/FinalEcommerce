...
const Otp =require("../model/forgotpassword");
    ...
    data.then(user => {
        if (!user) {
            ...
            data.then(otp => {
                ...
                res.status(500).send({
                    message: err.message || "Some error occurred while sending otp, Try again."
                });
            });
        }
    }
